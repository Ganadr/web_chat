<?php
    ...
    if(isset($_POST['submit'])){ // if user click the submit btn
        ...
        // Kiểm tra nếu email là admin và mật khẩu là 12345
        if($email == 'admin@gmail.com' && $password == md5('12345')) {
            // Nếu đúng, chuyển hướng đến trang admin.php
            //$_SESSION['user_id'] = 'admin@gmail.'; // Lưu session cho admin
